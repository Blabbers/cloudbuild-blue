...
var ASM_CONSTS = {
  1954648: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 1954703: ($0) => { performance.now = function() { return $0; }; },  
 1954751: ($0) => { performance.now = function() { return $0; }; },  
 1954799: () => { performance.now = Module['emscripten_get_now_backup']; }
};
