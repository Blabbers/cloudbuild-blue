...
var ASM_CONSTS = {
  1954856: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 1954911: ($0) => { performance.now = function() { return $0; }; },  
 1954959: ($0) => { performance.now = function() { return $0; }; },  
 1955007: () => { performance.now = Module['emscripten_get_now_backup']; }
};
