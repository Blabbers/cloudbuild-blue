...
var ASM_CONSTS = {
  1954872: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 1954927: ($0) => { performance.now = function() { return $0; }; },  
 1954975: ($0) => { performance.now = function() { return $0; }; },  
 1955023: () => { performance.now = Module['emscripten_get_now_backup']; }
};
