System.register([], function (_export, _context) {
  ...
  function createApplication(_ref) {
    ...
    function start(_ref4) {
      ...
      var settings;
      var cc; //inform the poki sdk that the game is loading.
      ...
      return Promise.resolve().then(function () {
        ...
        settings = window._CCSettings; //Set the debug value in pokisdk based on the build settings.
  ...
  function onGameStarted(cc, settings) {
    ...
    cc.director.loadScene(launchScene, null, function () {
      ...
      console.log("Success to load scene: ".concat(launchScene)); //Inform PokiSDK that we have finished loading the game.
